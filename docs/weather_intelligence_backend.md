...
- `crates/rustwx-products/src/shared_context.rs`
  - `WeatherPanelField::artifact_slug`: named-asset override used when an output file name should stay stable even if the display title changes
...
`WeatherPanelField` is the current named-asset primitive. It separates
