...
use rustwx_render::{
    Color, ContourLayer, DomainFrame, LevelDensity, LineworkRole, MapRenderRequest,
    ProductVisualMode, ProjectedDomain, ProjectedMap, RenderDensity, StaticPlotStyle,
    WindBarbLayer, build_projected_map as build_projected_map_from_latlon,
    map_frame_aspect_ratio_for_mode, render_image_with_style,
};
use serde::Serialize;
