...
use crate::shared_context::{
    model_time_subtitle_with_lead_label, source_subtitle, static_chrome_scale,
...
use rustwx_render::{
    save_png_profile_with_options, LegendMode, MapRenderRequest, PngCompressionMode,
    PngWriteOptions, ProductVisualMode, WeatherProduct,
};
