...
use rendering::{
    ...
    scale_for_earth2_selector, scale_for_recipe, streamlines_enabled_for_grid,
};
use rendering::{
    apply_source_raster_policy, build_render_request, earth2_filename_suffix,
    earth2_suppresses_companion_overlays, render_filled_field, sanitize_output_suffix,
