...
pub use derived::{
    ...
    compute_dcape, compute_dewpoint_from_pressure_and_mixing_ratio, compute_ehi_01km,
    ...
    compute_mucape_cin, compute_mucin,
    compute_relative_humidity_from_pressure_temperature_and_mixing_ratio, compute_sbcape,
    compute_sbcape_cin, compute_sbcin, compute_sblcl, compute_shear_01km, compute_shear_06km,
    compute_srh_01km, compute_srh_01km_hemispheric, compute_srh_03km,
