...
const KERNEL_SRC: &str =
    include_str!("../../../kernels/thermo/mixing_ratio_from_specific_humidity.cu");
...
pub fn host(ctx: &ContextHandle, specific_humidity: &[f64]) -> Result<Vec<f64>> {
    ...
    builder.arg(q_d.slice()).arg(w_d.slice_mut()).arg(&n_i32);
