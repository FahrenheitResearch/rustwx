//! `d²f/dy²` (boundary-aware) — port of met-cu's `second_derivative_y_kernel`.
//! Matches `wx_math::gridmath::second_derivative(.., axis=1, ..)` when `dy` is
//! a constant field.
...
const KERNEL_SRC: &str = include_str!("../../../kernels/grid/second_derivative_y.cu");
const MODULE_KEY: &str = "grid_second_derivative_y";
const FUNCTION: &str = "second_derivative_y_kernel";
