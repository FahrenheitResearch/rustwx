//! Horizontal advection `-u*df/dx - v*df/dy` — port of met-cu's
...
const KERNEL_SRC: &str = include_str!("../../../kernels/grid/advection.cu");
const MODULE_KEY: &str = "grid_advection";
const FUNCTION: &str = "advection_kernel";
