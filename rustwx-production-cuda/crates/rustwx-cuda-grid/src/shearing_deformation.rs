//! Shearing deformation `dv/dx + du/dy` — port of met-cu's
//! `shearing_deformation_kernel`. Matches `wx_math::dynamics::shearing_deformation`.
...
const KERNEL_SRC: &str = include_str!("../../../kernels/grid/shearing_deformation.cu");
const MODULE_KEY: &str = "grid_shearing_deformation";
const FUNCTION: &str = "shearing_deformation_kernel";
