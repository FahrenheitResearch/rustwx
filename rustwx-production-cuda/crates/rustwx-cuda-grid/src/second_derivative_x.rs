//! `d²f/dx²` (boundary-aware) — port of met-cu's `second_derivative_x_kernel`.
//! Matches `wx_math::gridmath::second_derivative(.., axis=0, ..)` when `dx` is
//! a constant field.
...
const KERNEL_SRC: &str = include_str!("../../../kernels/grid/second_derivative_x.cu");
const MODULE_KEY: &str = "grid_second_derivative_x";
const FUNCTION: &str = "second_derivative_x_kernel";
